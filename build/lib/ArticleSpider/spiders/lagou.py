...
class LagouSpider(CrawlSpider):
    ...
    def parse_job(self, response):
        ...
        item_loader.add_css("salary", ".job_requests .salary::text")
        ...
        item_loader.add_css("company_name", "#job_company dt a img::atr(alt")
        item_loader.add_css("company_url", "#job_company dt a::atr(alt")
